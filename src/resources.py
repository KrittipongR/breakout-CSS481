...
power_image_list = [sprite_collection["red_power"].image, 
                    sprite_collection["green_power"].image, 
                    sprite_collection["heart_power"].image, 
                    sprite_collection["skull_power"].image, 
                    sprite_collection["volUp_power"].image, 
                    sprite_collection["volDown_power"].image, 
                    sprite_collection["ball_power"].image, 
                    sprite_collection["block_power"].image, 
                    sprite_collection["blue_power"].image, 
                    sprite_collection["key_power"].image]
